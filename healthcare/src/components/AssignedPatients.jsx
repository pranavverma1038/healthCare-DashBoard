    ...
    <div>
      ...
      <ul>
        {assigned.map(p => (
          <motion.li
            key={p.id}
            className="mb-3 px-4 py-3 rounded-xl bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 dark:from-blue-900 dark:via-purple-900 dark:to-pink-900 shadow border border-blue-200 dark:border-blue-700 font-medium text-blue-900 dark:text-blue-100"
